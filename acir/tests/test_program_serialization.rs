...
fn simple_brillig_foreign_call() {
    ...
    let brillig_data = Brillig {
        inputs: vec![
            BrilligInputs::Single(Expression {
                // Input Register 0
                mul_terms: vec![],
                linear_combinations: vec![(FieldElement::one(), w_x), (FieldElement::one(), w_y)],
                q_c: FieldElement::zero(),
            }),
    ...
    let expected_serialization: Vec<u8> = vec![
        31, 139, 8, 0, 0, 0, 0, 0, 0, 255, 173, 145, 65, 10, 192, 32, 12, 4, 55, 106, 139, 207,
        177, 63, 232, 103, 122, 232, 165, 135, 82, 250, 126, 21, 21, 22, 204, 205, 44, 132, 132,
        37, 12, 36, 27, 1, 8, 154, 124, 41, 135, 89, 195, 59, 123, 79, 107, 58, 196, 144, 229, 236,
        88, 73, 57, 221, 140, 237, 137, 25, 232, 223, 85, 155, 242, 107, 158, 3, 121, 35, 171, 88,
        106, 239, 243, 253, 252, 215, 251, 137, 178, 197, 222, 132, 21, 232, 113, 103, 55, 40, 83,
        205, 19, 2, 0, 0,
    ];
